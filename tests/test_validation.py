...
@pytest.fixture
def log_handler(tmp_path) -> StatementLogHandler:
    return StatementLogHandler(log_dir=tmp_path)


class TestHeaderValidation:
    def test_malformed_headers(self, tmp_path):
    ...
    def test_missing_required_headers(self, tmp_path, log_handler):
    ...
    def test_header_field_validation(self, tmp_path, log_handler):
...
class TestTransactionValidation:
    def test_transaction_field_validation(self, tmp_path, log_handler):
    ...
    def test_suspicious_patterns(self, tmp_path, log_handler):
    ...
    def test_international_validation(self, tmp_path, log_handler):
...
class TestEncodingValidation:
    def test_encoding_handling(self, tmp_path, log_handler):
...
class TestRecoveryValidation:
    def test_partial_recovery(self, tmp_path, log_handler):
    ...
    def test_missing_fields_recovery(self, tmp_path, log_handler):
