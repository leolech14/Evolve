...
from statement_refinery.transaction_enricher import TransactionEnricher, MerchantProfile
...
def test_enhanced_categorization():
    ...
    t = Transaction(post_date="01/05", description="PAGAMENTO FATURA", amount_brl=Decimal("1000.00"))
...
def test_process_transactions():
    ...
    transactions = [
        ...
        Transaction(post_date="15/05", description="FARMACIA SAO JOAO", amount_brl=Decimal("50.00")),
        Transaction(post_date="15/06", description="FARMACIA SAO JOAO", amount_brl=Decimal("55.00")),
